...
public:
    ...
    {
        out << "Technician" << ' ' << get_name() << ' ' << get_sex() << ' ' << get_grade() << ' ' << workHours << ' '
            << hourRate << ' ' << get_birthMonth() << ' ' << get_birthDay() << '\n';
    }
};
...
public:
    ...
    void save(ofstream& out) override
    {
        out << "Manager" << ' ' << get_name() << ' ' << get_sex() << ' ' << get_grade() << ' ' << fixedSalary << ' '
...
public:
    ...
    float get_commissionRate()
    {
        return commissionRate;
    }
    int get_salary() override
    {
        return (int)(salesAmount * commissionRate);
    }
    void add_commissionRate()
    {
        commissionRate += 0.1f;
    }
    string get_role() override
    ...
    void save(ofstream& out) override
    {
        out << "Salesman" << ' ' << get_name() << ' ' << get_sex() << ' ' << get_grade() << ' ' << salesAmount << ' '
            << commissionRate << ' ' << get_birthMonth() << ' ' << get_birthDay() << '\n';
    }
};
...
{
public:
    Salesmanager(string name, string sex, int grade, int fixedSalary, int salesAmount, float commissionRate, int bm = 0,
                 int bd = 0)
        : Employee(name, sex, grade, bm, bd), Manager(name, sex, grade, fixedSalary, bm, bd),
    ...
    void promote() override
    {
        if (get_grade() < 5)
        {
            ...
            add_commissionRate();
            add_fixedSalary();
            cout << "已提升级别为" << get_grade() << ",提成比例增加0.1为" << get_commissionRate()
                 << ",固定薪资增加10000为" << get_fixedSalary() << endl;
        }
        else
            cout << "级别已最高" << endl;
    }
    ...
    void save(ofstream& out) override
    {
        out << "Salesmanager" << ' ' << get_name() << ' ' << get_sex() << ' ' << get_grade() << ' ' << get_fixedSalary()
            << ' ' << get_salesAmount() << ' ' << get_commissionRate() << ' ' << get_birthMonth() << ' '
            << get_birthDay() << '\n';
    }
};
